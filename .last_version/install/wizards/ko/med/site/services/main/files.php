...
*/
	...
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."about/video/", Array("SITE_DIR" => WIZARD_SITE_DIR));
...
//	WizardServices::ReplaceMacros($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/".WIZARD_TEMPLATE_ID."_".WIZARD_THEME_ID."/header.php", array("BREADCRUMB" => WIZARD_SITE_DIR));
	...
	$arNewUrlRewrite = array(
			array(
				"CONDITION" => "#^".WIZARD_SITE_DIR."about/articles/#",
				"RULE" => "",
				"ID" => "bitrix:news",
				"PATH" => WIZARD_SITE_DIR."about/articles/index.php",
			),
