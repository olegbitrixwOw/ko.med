...
$em = new CEventMessage;
		...
		$tempSubj = "Запись на прием с  сайта #SITE_NAME#";
		$tempText = "Запись на прием с сайта #SITE_NAME#<br>
------------------------------------------<br>
<br>
На сайте была оставлена заявка на Запись на прием<br>
<br>
Имя: #AUTHOR#<br>
...
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/".WIZARD_TEMPLATE_ID."_".WIZARD_THEME_ID."/footer.php", array("ADD_REVIEW_ID" => $event_id2));
