...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$siteLogo = $this->GetFileContentImgSrc(WIZARD_SITE_PATH."include/company_name.php", "/bitrix/wizards/ko/med/site/templates/med_by_ko/themes/".$themeID."/lang/".LANGUAGE_ID."/logo.png");
		if (!file_exists(WIZARD_SITE_PATH."include/logo.png"))
			$siteLogo = "/bitrix/wizards/ko/med/site/templates/med_by_ko/themes/".$themeID."/lang/".LANGUAGE_ID."/logo.png";
	...
	//	$this->content .= $this->ShowInputField("textarea", "siteCopy", Array("id" => "siteCopy", "class" => "wizard-field", "rows"=>"3")).'</div>';
		...
		$this->content .= '
		<div style="display: none;" id="bx_metadata" '.$styleMeta.'>
